#!/usr/bin/env node
/**
 * js-env-sanitizer setup (Jest + Mocha + Vitest)
...
const PLUGIN_NAME = 'module:js-env-sanitizer';
...
const log = (m) => console.log(`[js-env-sanitizer setup] ${m}`);
  ...
  if (exists(targetPath)) {
    ...
    function stripSanitizerInsideTuples(inner) {
      return inner.replace(/\[([^\]]*?)\]/g, (m, tupleInner) => {
        let t = tupleInner.replace(
          /(^|,)\s*(['"])module:js-env-sanitizer\2\s*(?=,|$)/g,
          (mm, lead) => (lead || '')
        );
    ...
    function addSanitizerToPluginsBlocks(code, pluginName) {
      ...
      while (true) {
        ...
        const hasTopLevel = /(^|,)\s*(['"])module:js-env-sanitizer\2\s*(?=,|$)/.test(
    ...
    function stripSanitizerFromPluginTuples(s) {
      ...
      s = s.replace(
        /(\[\s*['"][^'"]+['"][^\]]*?)\s*,\s*['"]module:js-env-sanitizer['"](\s*\])/g,
        '$1$2'
      );
      return s;
    }
...
(function ensureJest() {
  ...
  if (jestCfgPath) {
    ...
    if (/Auto-generated by js-env-sanitizer setup/.test(src)) {
      let out = src;
      if (hasTsJest) {
        out = out.replace(
          /transform:\s*\{[^}]*\}/m,
  ...
  const newCfg = hasTsJest
    ? `/** Auto-generated by js-env-sanitizer setup */
module.exports = {
...
(function ensureMocha() {
  ...
  const loaderSrc = `/* generated by js-env-sanitizer */
...
export async function load(url, context, nextLoad) {
  ...
  if (url.endsWith('.d.ts')) {
    return { format: 'module', source: 'export {}; /* js-env-sanitizer: ignored .d.ts */', shortCircuit: true };
  }
...
`;
  ...
  const registerSrc = String.raw`// Auto-generated by js-env-sanitizer
...
if (global.__JS_SANITIZER_HOOK__) {
  ...
  try { babel = require('@babel/core'); }
    ...
    console.warn('[js-env-sanitizer] Missing @babel/core. Install: npm i -D @babel/core');
    throw e;
  }
  ...
  function isIgnoredFile(filename) {
    ...
    if (lower.includes(sep + 'js-env-sanitizer' + sep)) return true;
  ...
  const BASE_OPTS = {
    ...
    caller: {
      name: 'js-env-sanitizer',
      version: '1',
      supportsStaticESM: false,
      supportsTopLevelAwait: false
    },
    ignore: [/node_modules[\\/](js-env-sanitizer)[\\/]/i]
  };
  ...
  function compileFile(code, filename) {
    ...
    if (ext === '.ts' || ext === '.tsx') {
      ...
      try { tsPreset = require.resolve('@babel/preset-typescript'); }
        ...
        throw new Error(
          '[js-env-sanitizer] TypeScript file "' + path.relative(process.cwd(), filename) + '" detected. ' +
  ...
  console.log('[js-env-sanitizer] require-hook active for', EXTS.join(', '));

  (async () => {
    if (process.env.JS_SANITIZER_DISABLE_ESM_LOADER === '1') {
      console.log('[js-env-sanitizer] ESM loader disabled via env');
      return;
    }
    try {
      ...
      if (typeof register === 'function') {
        ...
        console.log('[js-env-sanitizer] ESM loader registered');
      } else {
        console.warn('[js-env-sanitizer] node:module.register unavailable; ESM imports may bypass sanitizer');
      }
    } catch (e) {
      console.warn('[js-env-sanitizer] Could not register ESM loader:', e && (e.message || e));
    }
  })();
}
`;
  ...
  if (jsRc) {
    ...
    if (foundOpts) {
      ...
      const WANT_EXT = ['js','cjs','mjs','ts','tsx','jsx'];
      const content =
`// Auto-generated by js-env-sanitizer setup (minimal Mocha rc)
module.exports = {
...
(function ensureVitest() {
  ...
  if (!exists(setupPath)) {
    writeIfChanged(setupPath, `// Auto-generated by js-env-sanitizer setup for Vitest
...
`);
  ...
  const content = `// Auto-generated by js-env-sanitizer setup
